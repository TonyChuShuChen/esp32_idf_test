...
static void lcdIfaceInit() {
	...
	WRITE_PERI_REG(GPIO_FUNC0_OUT_SEL_CFG_REG, (I2S1O_DATA_OUT8_IDX<<GPIO_FUNC0_OUT_SEL_S));
	WRITE_PERI_REG(GPIO_FUNC2_OUT_SEL_CFG_REG, (I2S1O_DATA_OUT9_IDX<<GPIO_FUNC0_OUT_SEL_S));
	WRITE_PERI_REG(GPIO_FUNC5_OUT_SEL_CFG_REG, (I2S1O_DATA_OUT10_IDX<<GPIO_FUNC0_OUT_SEL_S));
	WRITE_PERI_REG(GPIO_FUNC16_OUT_SEL_CFG_REG, (I2S1O_DATA_OUT11_IDX<<GPIO_FUNC0_OUT_SEL_S));
	WRITE_PERI_REG(GPIO_FUNC17_OUT_SEL_CFG_REG, (I2S1O_DATA_OUT12_IDX<<GPIO_FUNC0_OUT_SEL_S));
	WRITE_PERI_REG(GPIO_FUNC18_OUT_SEL_CFG_REG, (I2S1O_DATA_OUT13_IDX<<GPIO_FUNC0_OUT_SEL_S));
	WRITE_PERI_REG(GPIO_FUNC19_OUT_SEL_CFG_REG, (I2S1O_DATA_OUT14_IDX<<GPIO_FUNC0_OUT_SEL_S));
	WRITE_PERI_REG(GPIO_FUNC20_OUT_SEL_CFG_REG, (I2S1O_DATA_OUT15_IDX<<GPIO_FUNC0_OUT_SEL_S));
	WRITE_PERI_REG(GPIO_FUNC26_OUT_SEL_CFG_REG, (I2S1O_DATA_OUT16_IDX<<GPIO_FUNC0_OUT_SEL_S)); //RS
	WRITE_PERI_REG(GPIO_FUNC11_OUT_SEL_CFG_REG, (I2S1O_WS_OUT_IDX<<GPIO_FUNC0_OUT_SEL_S));
#else
